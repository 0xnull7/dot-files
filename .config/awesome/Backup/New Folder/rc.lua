...
local browser      = "brave"
local guieditor    = "code" -- Visual Studio Code
...
awful.layout.layouts = {
    ...
    lain.layout.centerwork.horizontal,	--6
    lain.layout.termfair.center,		--7
    lain.layout.termfair,				--8
    lain.layout.centerwork,				--9
--    awful.layout.suit.tile.left,		--10
...
beautiful.init("/home/usb/.config/awesome/themes/msjche/theme.lua")
-- }}}
...
--    awful.key({ altkey }, "p", function() os.execute("screenshot") end),
    ...
    awful.key({ modkey, "Control" }, "Left", function () awful.screen.focus_relative(-1) end,	--Switch between monitors
...
--		end)
    ...
    awful.key({ modkey }, "r", function () awful.spawn(string.format("rofi -show drun")) end,
...
--      properties = { titlebars_enabled = true } },
    ...
    -- Set brave to always map on the first tag on screen 2.
--    { rule = { class = "brave" },
